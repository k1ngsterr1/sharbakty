...
const service = require("../../assets/service_02_m.webp");
...
const AcceptancePage = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Услуги по приемке зерна - Sharbakty Bidai</title>
        <meta
          property="og:title"
          content="Услуги по приемке зерна - Sharbakty Bidai"
        ></meta>
        <meta
          property="og:description"
          content="Мы обеспечиваем быструю и эффективную приемку зерна с помощью современных методов и оборудования."
        ></meta>
        <meta
          name="description"
          content="Мы обеспечиваем быструю и эффективную приемку зерна с помощью современных методов и оборудования."
      ...
      <section className="screen">
        ...
        <main className="content mt64">
          ...
          <h1 className="main-heading blue mt8 mb16">Приемка зерна</h1>
          <p className="paragraph blue fw300 center m-auto ">
            Приемка Зерна с Гарантией Качества: В Шербакты Бидай каждое зерно
            проходит строгий контроль, обеспечивая быструю и надежную приемку
            вашего урожая с высшим стандартом качества.
          </p>
        ...
        <main className="content-pc-service mt90">
          <div className="text-content">
            ...
            <p className="paragraph blue fw300 left w40">
              ...
              влажности и температуры, гарантируя сохранность и качество зерна
              на каждом этапе хранения.
            </p>
          ...
          <div className="service-content">
            ...
            <div className="service-content-tab" id="about">
              ...
              <p className="paragraph w60">
                ...
                климата, обеспечивают идеальные условия для вашего урожая,
                сохраняя его свежесть, качество и питательные свойства. Мы
                тщательно контролируем параметры влажности и температуры,
                минимизируя риски и обеспечивая долгосрочное безопасное
                хранение. Благодаря обширному опыту и высокой квалификации нашей
                команды, вы можете быть уверены в сохранности и целостности
                вашего зерна от момента поступления на хранение и до момента его
                отгрузки. Выбирая нас, вы выбираете надежность и профессионализм
                в каждом зерне.
              </p>
            </div>
        ...
        <div className="content mt32">
          ...
          <p className="paragraph">
            ...
            хранение и до момента его отгрузки. Выбирая нас, вы выбираете
            надежность и профессионализм в каждом зерне.
          </p>
