...
const DrainPage = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Услуги по высушиванию зерна -Sharbakty Bidai Terminal</title>
        <meta
          property="og:title"
          content="Услуги по высушиванию зерна - Sharbakty Bidai Terminal"
        ></meta>
        <meta
      ...
      <section className="screen">
        ...
        <main className="content mt64">
          ...
          <h1 className="main-heading blue mt8 mb16">Сушка зерна</h1>
          <p className="paragraph blue fw300 center m-auto ">
            "Безупречная Отгрузка с Шербакты Бидай: Мы гарантируем своевременную
            и безопасную отгрузку вашего урожая, обеспечивая высокие стандарты
            качества и сохранности зерна с использованием передовых технологий.
          </p>
