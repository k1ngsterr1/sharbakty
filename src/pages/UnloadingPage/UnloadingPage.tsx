...
const UnloadingPage = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Услуги по разгрузке зерна - Sharbakty Bidai Terminal</title>
        <meta
          property="og:title"
          content="Услуги по разгрузке зерна - Sharbakty Bidai Terminal"
        ></meta>
        <meta
      ...
      <section className="screen">
        ...
        <main className="content mt64">
          ...
          <h1 className="main-heading blue mt8 mb16">Отгрузка зерна</h1>
