  ...
  return (
    <section className="screen mt32" id="about">
      <div className="content">
        <Separator number="01" />
        <h2 className="heading-s left mt32">О Компании</h2>
        <p className="paragraph mt16">
          <span className="focused"> ТОО "Sharbakty Bidai Terminal"</span>—
          современный терминал и элеватор, специализирующийся на хранении и
          отгрузке сельскохозяйственных продуктов. Расположенный в стратегически
          важном регионе, этот терминал служит центральным узлом для множества
          аграрных операций, обеспечивая сельскохозяйственным предприятиям и
          фермерам эффективное хранение и транспортировку их урожаев.
        </p>
