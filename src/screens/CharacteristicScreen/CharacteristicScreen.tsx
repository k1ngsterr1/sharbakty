    ...
    <div className="screen">
      <section className="content" id="char">
        ...
        <p className="paragraph mt32 w95">
          <span className="focused">Хранение и сортировка:</span> Компания
          предоставляет услуги по хранению различных видов сельскохозяйственных
          культур и осуществляет их сортировку в соответствии с требованиями
          клиентов.
        </p>
        <p className="paragraph mt32 w95">
        ...
        <div className="screen-content space-between items-center">
          ...
          <div className="text-content items-end">
            ...
            <p className="paragraph mt32 w50">
              <span className="focused">Хранение и сортировка:</span> {""}
